...
for streamid in uniqueStreamIds:
	avtpfile = str(sys.argv[1]).split('.')[0] + "_AVTPtimestampdiff_for_sId_" +streamid+ ".csv"
	avtpPacketParserforSpecificStreamID(sys.argv[1], avtpfile, 1332995, 1333999, streamid)
